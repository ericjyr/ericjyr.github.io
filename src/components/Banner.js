...
export const Banner = () => {
  ...
  const toRotate = [ "Full Stack Developer", "Backend Developer", "Cat Lover" ];
  const period = 2000;
          ...
          <Col xs={12} md={6} xl={7}>
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                ...
                <h1>{`Hi! I'm Eric! `} <span className="txt-rotate" dataPeriod="1000" data-rotate='[ "Full Stack Developer", "Backend Developer", "Cat Lover" ]'><span className="wrap">{text}</span></span></h1>
